...
export const homeCopy = {
  en: {
    ...
    experienceTitle: "From test engineering to enterprise AI delivery",
    experiences: [
      [
        "2025.11 — Present",
        "Large bank client project",
        "AI Agent Engineer / AI Application Technical Lead",
        "For a bank testing and data-analysis program, I design and deliver Agent workflows for batch-job parsing, requirement understanding, test-case generation, automation-script generation and audit-ready review. I connect code analysis, clustering and evaluation with cross-team delivery, then leave reusable workflows and standardized templates.",
      ],
      [
        "2024.12 — 2025.11",
        "Vico Electronics",
        "AI Platform Engineer / Automation Platform Lead",
        "I led enterprise AI platform and intelligent automation delivery across Dify extensions, multi-model integration, Agent workflows and internal tools, from requirement breakdown through release. I connected knowledge bases, batch processing and business systems so teams could reuse AI capabilities in daily operations.",
      ],
      [
        "2022.07 — 2024.12",
        "Jintu Computing",
        "Software Development Engineer in Test",
        "I built automated test frameworks, API and UI test systems, quality tools and diagnostics for multi-domain delivery. The framework architecture and automation practice established the engineering foundation for my later AI-assisted test generation and platform work.",
      ],
    ],
  ...
  zh: {
    ...
    experienceTitle: "从测试工程到企业 AI 解决方案交付",
    experiences: [
      [
        "2025.11 — 至今",
        "大型银行客户项目",
        "AI Agent 开发工程师 / AI 应用技术负责人",
        "面向银行测试与数据分析场景，负责 Agent 方案设计与落地，建设作业解析、需求理解、测试用例生成、自动化脚本生成及审计流程。结合代码分析、聚类算法与效果评估推进跨团队交付，并沉淀可复用的智能体流程和标准化模板。",
      ],
      [
        "2024.12 — 2025.11",
        "维客电子有限公司",
        "AI 平台开发工程师 / AI 自动化平台负责人",
        "负责企业 AI 平台与智能自动化能力建设，围绕 Dify 二次开发、多模型接入、Agent 工作流和内部工具完成需求拆解、方案设计与上线交付。推动知识库、批量任务与业务系统集成，提升 AI 能力的复用性和实际可用性。",
      ],
      [
        "2022.07 — 2024.12",
        "锦图计算",
        "测试开发工程师",
        "负责自动化测试框架、接口与 UI 测试、质量工具及复杂问题诊断能力建设，参与多领域项目的测试方案和工程化交付。沉淀框架架构与自动化经验，为后续 AI 测试生成和智能化平台建设打下基础。",
      ],
    ],
